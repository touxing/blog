import{_ as n,X as s,Y as a,a3 as p}from"./framework-e83cfa57.js";const t={},e=p(`<h1 id="职责链模式" tabindex="-1"><a class="header-anchor" href="#职责链模式" aria-hidden="true">#</a> 职责链模式</h1><p>3 ⭐</p><p>明确各个对象的职责，如果一个对象没有权限，内部设置自动抛给有权限处理的对象</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 定义一个公共类</span>
