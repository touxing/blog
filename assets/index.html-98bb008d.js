import{_ as n,X as s,Y as a,a3 as t}from"./framework-e83cfa57.js";const e={},p=t(`<h1 id="模拟实现new关键字功能" tabindex="-1"><a class="header-anchor" href="#模拟实现new关键字功能" aria-hidden="true">#</a> 模拟实现new关键字功能</h1><p>在js中new关键字主要做了： 首先创建一个空对象，这个对象会作为执行new构造函数之后返回的对象实例， 将创建的空对象原型（<code>__proto__</code>）指向构造函数的prototype属性，同时将这个空对象赋值给构造函数内部的this，并执行构造函数逻辑，根据构造函数的执行逻辑，返回初始创建的对象或构造函数的显式返回值。</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">/*
