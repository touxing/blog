import{_ as s,X as l,Y as d,Z as n,$ as e,a1 as a,a0 as r,C as t}from"./framework-127c059f.js";const v={},u=n("h1",{id:"jenkins",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#jenkins","aria-hidden":"true"},"#"),e(" Jenkins")],-1),c=n("h2",{id:"安装-基于centos",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#安装-基于centos","aria-hidden":"true"},"#"),e(" 安装（基于CentOS)")],-1),o={href:"https://www.jenkins.io/zh",target:"_blank",rel:"noopener noreferrer"},m=r(`<ul><li>下载 war 包，Tomcat中运行 <code>java -jar jenkins.war --HttpPort=8080</code></li><li>yum 安装</li><li>docker 安装（推荐）</li></ul><p>根据官网安装 Docker 环境</p><blockquote><p>国内配置清华源 Fedora/CentOS/RHEL 以下内容根据 官方文档 修改而来。</p></blockquote><p>如果你之前安装过 docker，请先删掉</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> yum remove <span class="token function">docker</span> docker-common docker-selinux docker-engine
