import{_ as n,X as s,Y as a,a1 as p}from"./framework-2b07d456.js";const t={},e=p(`<h1 id="回溯算法" tabindex="-1"><a class="header-anchor" href="#回溯算法" aria-hidden="true">#</a> 回溯算法</h1><p>解决一个回溯问题，实际是一棵决策树的遍历过程</p><p>思考3个问题：</p><ol><li>路径：已经做出的选择</li><li>选择列表：当前可以做的选择</li><li>结束条件：达到决策的底层，无法再做选择</li></ol><p>回溯算法框架</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code>result <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token punctuation">]</span>
