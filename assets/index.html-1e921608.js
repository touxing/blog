import{_ as n,X as s,Y as a,a1 as p}from"./framework-2b07d456.js";const t={},o=p(`<h1 id="javascript-中的-this" tabindex="-1"><a class="header-anchor" href="#javascript-中的-this" aria-hidden="true">#</a> javascript 中的 this</h1><h2 id="改变this指向" tabindex="-1"><a class="header-anchor" href="#改变this指向" aria-hidden="true">#</a> 改变this指向</h2><h2 id="bind-方法实现" tabindex="-1"><a class="header-anchor" href="#bind-方法实现" aria-hidden="true">#</a> bind 方法实现</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">/*
 * @Author: HotSuitor
